...
const ProductItem = ({ product }: ProductItemProp) => {
  ...
  return (
    <div className="w-full">
      <div className="w-full hidden md:block h-[350px] border border-gray-300 cursor-pointer group overflow-hidden">
        {/* Image section */}
      ...
      {/* mobile */}
      <div className="w-full md:hidden h-[450px] border border-gray-300 cursor-pointer  overflow-hidden">
        {/* Image section */}
        <div className="h-[70%] w-full overflow-hidden">
          <img
            src={product.image}
        ...
        <div className="h-[30%]">
          ...
          <motion.div
            ...
            className="flex items-center justify-evenly gap-3 relative"
          >
            {/* SEARCH ICON */}
            <div className=" ">
              <Link
